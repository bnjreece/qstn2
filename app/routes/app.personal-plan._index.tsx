  ...
  return (
    <Form method="post" className="space-y-8">
      ...
      <div className="space-y-12">
        ...
        {/* Question */}
        <div>
          <h2 className="text-4xl font-light text-gray-900">{currentQuestion.title}</h2>
          {currentQuestion.description && (
            <p className="mt-4 text-xl font-light text-gray-600">{currentQuestion.description}</p>
          )}
        </div>
